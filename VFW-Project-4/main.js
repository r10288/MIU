...
//at this moment but might want later.
/*
Images are from:
    ...
    http://www.easyvectors.com/browse/other/909713a32d72f67a01e403799bacacdf-skull-clip-art
*/
...
window.addEventListener("DOMContentLoaded", function doItAll(){
    ...
    function validate(e){
        ...
        //var getDeadly = $("deadly");
        //var getDate = $("date");

        errMsg.innerHTML = "";
        getWeaponName.style.border = "1px solid black";
        getWeaponCategory.style.border = "1px solid black";
        //getDeadly.style.border = "1px solid black";
        //getDate.style.border = "1px solid black";

        var messageArray = [];

        /*var missingDataMessage = "Required fields missing.";
        messageArray.push(missingDataMessage);*/
        ...
        /*if(getDeadly.value === ""){
         var deadlyError = "Please select the deadliness of the weapon.";
         getDeadly.style.border = "1px solid red";
         messageArray.push(deadlyError);
         }*/
